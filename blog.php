...
?>
    <main>
      ...
      <div class="grid-item mnogo">
        ...
        <p class="resizeText">Z útulku ju vzal môj sused a pomenoval ju Musia. Chcel, aby mačka chytala myši v lese pri jeho vidieckom dome, priamo vedľa ktorého som práve bývala. Prichádzal do tohto domu cez víkendy a v pracovné dni sa vrátil do mesta. Mačka bežala za odchádzajúcim autom každý raz, ale sused nezastavoval.</p>        
      </div>
      ...
      <div class="grid-item mnogo">
        ...
        <p class="resizeText">Aby sme ju prepravili z Ruska do Slovenska, museli sme ju očkovať očkovacími látkami európskych výrobcov. Týchto vakcín v Rusku takmer niet, od roku 2022 ich prestali dovážať. Ale podarilo sa mi nájsť potrebné lieky, a manželovi sa podarilo kúpiť letenky na lietadlo pre mačky hneď na tri lety s dvoma prestupmi: z mojho rodného Jekaterinburgu do Moskvy, z Moskvy do Istanbulu a z Istanbulu do Viedne. Manžel s mačkou lietali dva dni a boli veľmi unavení, ale zvládli to, a teraz moja mačka žije v Nitre.</p>        
      </div>
      
      <button id="changeSize">+Аа</button>
